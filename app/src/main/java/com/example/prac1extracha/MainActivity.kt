...
class MainActivity : AppCompatActivity() {
    ...
    private fun sum3(){
        ...
        //val y = Integer.parseInt(resultText2.text.toString())
        //val z = Integer.parseInt(resultText3.text.toString())
    ...
    private fun sum4(){
        ...
        //var x = Integer.parseInt(resultText.text.toString())
        //var y = Integer.parseInt(resultText2.text.toString())
        //var z = Integer.parseInt(resultText3.text.toString())
